...
研究对象：代理变量、奖励、排名、度量、优化目标如何从描述器变成系统的实际控制面。
...
2. 结构可以脱离原对象名称后仍然成立。
3. 含有反馈、阈值、路径依赖、多时间尺度、形态变化、资源流、边界变化、选择压力、测量反馈、激励适应、环境建构、共同适应或恢复机制中的至少一种。
4. 能挑战常见 Agent 默认假设。
5. 可以提出安全的模拟、对照与消融实验。
...
本书不限制来源于“自然”。任何现实结构——生物、地质、水文、经济、法律、组织、平台、战争、语言、城市、宗教、市场、教育、机器系统——只要能让强模型重新审视自己的默认架构先验，都可以进入候选池。
